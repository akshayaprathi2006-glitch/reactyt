...
const RightCardContent = (props) => {
  return (
        ...
        <div>
            <p className='text-xl leading-relaxed  text-white mb-14 '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias possimus vel, natus labore eaque iusto?</p>
